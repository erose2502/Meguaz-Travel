...
export default function OnboardingFlow({ onComplete }: OnboardingFlowProps) {
  ...
  const next = () => {
    // Home base powers "leave home by" solving; keep it for the trip brief.
    if (steps[step].isAddress && address.trim()) {
      localStorage.setItem('meguaz_home_base', address.trim())
    }
